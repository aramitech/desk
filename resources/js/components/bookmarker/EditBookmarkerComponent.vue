<template>
        ...
        <form method="POST" @submit.prevent="submit">
                    <div class="modal-body">
                       ...
                       <div class="col-md-6">
							...
							<input class="form-control" name="licensee_name" v-model="fields.licensee_name" type="text" placeholder="" required>
 ...
 <div class="col-md-6">
            ...
            <multiselect  name="Bookmarkers_company_id" v-model="fields.Bookmarkers_company_id"  track-by="Bookmarkers_company_id" label="company_name" placeholder="" :options="company_names"  :allow-empty="true" :multiple="false" :hide-selected="true" :max-height="150" @input="onChange" >
  ...
  <div class="form-group row">
					<div class="col-md-6">
							...
							<input class="form-control" name="trading_name" v-model="fields.trading_name" value="" type="text" placeholder="" >
...
<div class="form-group row">  
                           <div class="col-md-4">
							...
							<input class="form-control"  name="total_sales" v-model="fields.total_sales" value="" type="text" placeholder="" required>
                            <div v-if="errors && errors.total_sales" class="text-danger">{{ errors.total_sales[0] }}</div>
						</div>
                            <div class="col-md-4">
							<label>Total Payout</label>
							<input class="form-control"  name="total_payout" v-model="fields.total_payout" value="" type="text" placeholder=" " required>
                            <div v-if="errors && errors.total_payout" class="text-danger">{{ errors.total_payout[0] }}</div>
						</div></div>
  <div class="form-group row">                       
                           <div class="col-md-4">
							<label>WHT</label>
							<input class="form-control"  name="wht" v-model="fields.wht" value="" type="text" placeholder="" required>
                            <div v-if="errors && errors.wht" class="text-danger">{{ errors.wht[0] }}</div>
						</div>
                           <div class="col-md-4">
							<label>Win Loss</label>
							<input class="form-control"  name="winloss" v-model="fields.winloss" value="" type="text" placeholder="" required>
                            <div v-if="errors && errors.winloss" class="text-danger">{{ errors.winloss[0] }}</div>
						</div>
                           <div class="col-md-4">
							<label>GGR</label>
							<input class="form-control"  name="ggr" v-model="fields.ggr" value="" type="text" placeholder="" required>

        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myLargeModalLabel">Upload Bookmarkers Company</h4>
...
<div class="form-group col-md-12">
							...
							<div class="alert alert-info shadow-sm col-md-12">
								<a class="border-left" href="/desk/public/sample/BookmarkersCompany.xlsx">Download Sample File</a>
                            </div>
						</div>
<!-- //////////////////////////////////////////////// -->     
...
data() {
    return {
        action: '/desk/public/bookmarkerscompany/upload', //save action

<template>
    <div class="modal fade" id="uploadbookmarkerscompany" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myLargeModalLabel">Upload Public Lottery Company</h4>
...
<div class="form-group col-md-12">
							...
							<div class="alert alert-info shadow-sm col-md-12">
								<a class="border-left" href="/desk/public/sample/PublicLotteryCompany.xlsx">Download Sample File</a>
                            </div>
						</div>
<!-- //////////////////////////////////////////////// -->    
...
data() {
    return {
        action: '/desk/public/publiclotterycompany/upload', //save action

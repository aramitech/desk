<template>
    <div class="modal-content">
       ...
       <form method="POST" @submit.prevent="submit">
					...
					<div class="col-md-6">
							...
							<input class="form-control" name="company_name" v-model="fields.company_name" type="text" placeholder=" " required>
                            <div v-if="errors && errors.company_name" class="text-danger">{{ errors.company_name[0] }}</div>
						</div>
						<div class="col-md-6">
							<label>Trading Name</label>
							<input class="form-control" name="trading_name" v-model="fields.trading_name" value="" type="text" placeholder=" " required>
                            <div v-if="errors && errors.trading_name" class="text-danger">{{ errors.trading_name[0] }}</div>
						</div></div>
      <div class="form-group row">
                        <div class="col-md-6">
							<label>License No</label>
							<input class="form-control"  name="license_no" v-model="fields.license_no" value="" type="text" placeholder=" " required>
                            <div v-if="errors && errors.license_no" class="text-danger">{{ errors.license_no[0] }}</div>
						</div>
                        <div class="col-md-6">
							<label>Email</label>
							<input class="form-control"  name="email" v-model="fields.email" value="" type="email" placeholder="" required>
                            <div v-if="errors && errors.email" class="text-danger">{{ errors.email[0] }}</div>
						</div></div>
      <div class="form-group row">
                           <div class="col-md-6"> 
							<label>Contact</label>
							<input class="form-control"  name="contact" v-model="fields.contact" value="" type="text" placeholder="" required>
                            <div v-if="errors && errors.contact" class="text-danger">{{ errors.contact[0] }}</div>
						</div>
                            <div class="col-md-6">
							<label>Physical Location</label>
							<input class="form-control"  name="physicaladdress" v-model="fields.physicaladdress" value="" type="text" placeholder=" " required>
      ...
      <div class="form-group row">
                           <div class="col-md-6">
							...
							<input class="form-control"  name="directorsshareholder" v-model="fields.directorsshareholder" value="" type="text" placeholder=" " required>
							...
							<input class="form-control"  name="shareholdingstructure" v-model="fields.shareholdingstructure" value="" type="text" placeholder=" " required>
      ...
      <div class="form-group row">
                           <div class="col-md-6">
							...
							<input class="form-control"  name="nationality" v-model="fields.nationality" value="" type="text" placeholder="" required>
                            <div v-if="errors && errors.nationality" class="text-danger">{{ errors.nationality[0] }}</div>
						</div>
                            <div class="col-md-6">
							<label>Company Registration</label>
							<input class="form-control"  name="companyregistration" v-model="fields.companyregistration" value="" type="text" placeholder=" " required>
 ...
 <div class="form-group row">
                       <div class="col-md-6">
							...
							<input class="form-control"  name="paybillno" v-model="fields.paybillno" value="" type="text" placeholder=" " >
                            <div v-if="errors && errors.paybillno" class="text-danger">{{ errors.paybillno[0] }}</div>
					
						
							<input class="form-control"  name="branch" v-model="fields.branch" value="" type="hidden" placeholder="" >
						</div>
                        
            <div class="col-md-6">
							<label>KRA PIN </label>
							<input class="form-control"  name="krapin" v-model="fields.krapin" value="" type="text" placeholder="" >

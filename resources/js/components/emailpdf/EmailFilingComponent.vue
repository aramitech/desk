<template>
    <div class="modal fade" id="emailfilingpdf" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myLargeModalLabel">MAIL FILING AS PDF</h4>
...
data() {
    return {
        action: '/desk/public/send-mail-filing', //save action

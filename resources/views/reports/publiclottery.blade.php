    ...
    <div class="page-header">
				...
				<div class="invoice-wrap">
					<div class="invoice-box">
                        ...
                        <div class="row pb-30">   
							<div class="col-md-6"> 
								<h5 class="mb-15">NAME OF LICENSEE</h5>
								<p class="font-14 mb-5">LICENSEE NO: <strong class="weight-600">.........</strong></p>
								<p class="font-14 mb-5">RETURN FOR THE PERIOD OF: <strong class="weight-600">..........</strong></p>
							</div>
							<div class="col-md-6">
								<div class="text-right">
									<p class="font-14 mb-5">BRANCH </strong></p>
									<p class="font-14 mb-5">DATE</p>
                    ...
                    @endforeach   
							...
							<div class="invoice-desc-footer">
								<div class="invoice-desc-head clearfix">
									...
									<div class="invoice-subtotal">MANAGER/ SUPERVISOR</div>
								</div>

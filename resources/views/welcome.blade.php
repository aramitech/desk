...
<head>
    ...
    <title>BCLB Login</title>
    <link rel="apple-touch-icon" href="tyu/app-assets/images/ico/apple-icon-120.png">
    <link rel="shortcut icon" type="image/x-icon" href="tyu/app-assets/images/ico/favicon-16x16e.png">
    ...
    <link rel="stylesheet" type="text/css" href="tyu/app-assets/css/pages/authentication.css">
    <!-- END: Page CSS-->

    <!-- BEGIN: Custom CSS-->
    <link rel="stylesheet" type="text/css" href="tyu/assets/css/style.css">
    <!-- END: Custom CSS-->
                        ...
                        <div class="card bg-authentication rounded-0 mb-0">
                            <div class="row m-0">
                                <div class="col-lg-6 d-lg-block d-none text-center align-self-center px-1 py-0">
                                    <img src="tyu/app-assets/images/pages/istockphoto.jpg" alt="branding logo">
                                </div>

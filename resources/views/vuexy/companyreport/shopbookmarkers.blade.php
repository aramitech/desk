                  ...
                  <div class="card">
                        ...
                        <div class="card-content collapse">
                            <div class="card-body">
                               ...
                               <select id="aggregation-farmer-id" onchange="goToTestshop(this.value)" name="farmer_id" class="form-control" style="width: 100%; border-color: #ebedf2;">
                                    <option value="">- Select -</option>
                                    @foreach($bookmarkerscompanynames as $bookmarkerscompanyname)
                                        <option value="{{ $bookmarkerscompanyname->company_name }}">{{ $bookmarkerscompanyname->company_name }}</option>
                                    @endforeach
                                </select>
...
<script>
function goToTestshop(id) {
  window.location.href = "{{ route('shopcompanystatus') }}"+id;
}
...
function goToTestPage(id) {
  window.location.href = "{{ route('shopcompanystatus') }}"+id;
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{ $bookmarker->shop_id }}</td>
                        <td> @if($bookmarker->Shopcompany) 
                        {{  $bookmarker->Shopcompany->company_name }}
                        @endif</td>
                        <td>{{ $bookmarker->shop_name }}</td>
                        <td>{{ $bookmarker->location }}</td>
                        <td>{{ $bookmarker->shop_number }}</td>
                   
                        <td> @if($bookmarker->Shopcompany) 
                        {{  $bookmarker->Shopcompany->trading_name }}
                        @endif</td>

                ...
                <div class="card">
                    <div class="card-content">
                        ...
                        @endif" > </div>
                                            ...
                                            @if ( Auth::user()->bookmarkers_group == 'Allowed' )
                                                ...
                                                @else  @endif
                                                @if ( Auth::user()->public_lottery_group == 'Allowed' )
                                                ...
                                                @else  @endif
                                                @if ( Auth::user()->public_gaming_group == 'Allowed' )
                                                ...
                                                @else  @endif
                                                @if ( Auth::user()->actions_group == 'Allowed' )
                                                ...
                                                @else  @endif
                                                @if ( Auth::user()->admin_assign_companies == 'Allowed' )
                                                ...
                                                @else  @endif
                                                @if ( Auth::user()->admin_assign_accounts == 'Allowed' )
...
@else  @endif
                                                @if ( Auth::user()->admin_assign_registry == 'Allowed' )

...
function goToTestPage(id) {
  window.location.href = "{{ route('companystatus') }}"+id;
				...
				@endphp
                    ...
                    @foreach($bcompanies  as $publicgaming)
                    @php 
                $sales +=$publicgaming->publicGamingcompany->sum('sales') ;
				 $payouts +=$publicgaming->publicGamingcompany->sum('payouts') ;
				 $wht +=$publicgaming->wht ;
				 $ggr +=$publicgaming->publicGamingcompany->sum('ggr') ;
				 $ggrtax +=$publicgaming->ggrtax ;
				 $salesslot +=$publicgaming->publicGamingcompany->sum('salesslot') ;
                 $payoutsslot +=$publicgaming->publicGamingcompany->sum('payoutsslot') ;
                 $whtslot +=$publicgaming->whtslot ;
                 $ggrslot +=$publicgaming->publicGamingcompany->sum('ggrslot') ;
                ...
                <tr>
                        ...
                        <td>{{ $publicgaming->publicGamingcompany->sum('sales') }}</td>
                        <td>{{ $publicgaming->publicGamingcompany->sum('payouts') }}</td>
                        <td>{{ $publicgaming->publicGamingcompany->sum('ggr') }}</td>
                
                        <td>{{ $publicgaming->publicGamingcompany->sum('salesslot') }}</td>
                        <td>{{ $publicgaming->publicGamingcompany->sum('payoutsslot') }}</td>
                        <td>{{ $publicgaming->publicGamingcompany->sum('ggrslot') }}</td>
            ...
            <td style="background-color:#aaf228" >{{ $payoutsslot }}</td>
